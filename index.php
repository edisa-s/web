<?php
    require_once ($_SERVER['DOCUMENT_ROOT'].'/projektiwebb/views/showRooms.php');
    require_once ($_SERVER['DOCUMENT_ROOT'].'/projektiwebb/views/showServices.php');
    require_once ($_SERVER['DOCUMENT_ROOT'].'/projektiwebb/views/showPages.php');
    require_once ($_SERVER['DOCUMENT_ROOT'].'/projektiwebb/admin/functions.php');
?>
